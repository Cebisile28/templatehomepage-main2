    ...
    <>
      ...
      <main className="w-full">
        ...
        <section className="py-20 px-4 md:px-10 bg-white dark:bg-gray-900 transition-colors duration-500">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">Core Services</h2>
              <p className="text-gray-600 dark:text-gray-400 text-lg max-w-2xl mx-auto">Our foundation services built to deliver exceptional value and impact</p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {coreServices.map((service, index) => {
                ...
                return (
                  <div key={index} className="bg-gray-50 dark:bg-gray-800 rounded-lg p-8 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border border-gray-200 dark:border-gray-700">
        ...
        <section className="py-20 px-4 md:px-10 bg-gradient-to-r from-gray-100 to-gray-50 dark:from-gray-800 dark:to-gray-900 transition-colors duration-500">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">Premium Solutions</h2>
              <p className="text-gray-600 dark:text-gray-400 text-lg max-w-2xl mx-auto">Advanced services for businesses looking to scale and innovate</p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {premiumServices.map((service, index) => {
                const Icon = service.icon;
                return (
                  <div key={index} className="bg-white dark:bg-gray-800 rounded-lg p-8 shadow-md hover:shadow-xl transition-all duration-300 border-l-4 border-amber-400">
                    <Icon className="w-12 h-12 text-amber-400 mb-4" />
        ...
        <section className="py-20 px-4 md:px-10 bg-white dark:bg-gray-900 transition-colors duration-500">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">Why Choose Boostify?</h2>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <div className="bg-gradient-to-br from-amber-400 to-yellow-500 rounded-lg p-8 text-black shadow-lg">
                ...
                <p className="text-base mb-6 leading-relaxed">We're committed to delivering exceptional results that exceed your expectations. Every project is an opportunity to showcase our dedication to excellence and innovation.</p>
                <p className="text-base font-semibold">Your success is our success. Let's build something amazing together.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-4 md:px-10 bg-gray-50 dark:bg-gray-800 transition-colors duration-500">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-lg max-w-2xl mx-auto">A streamlined approach to delivering exceptional results</p>
            </div>
              ...
              {[
                ...
                <div key={index} className="relative">
                  <div className="bg-white dark:bg-gray-700 rounded-lg p-6 shadow-md text-center h-full">
                    <div className="w-12 h-12 bg-amber-400 text-black rounded-full flex items-center justify-center font-bold text-lg mx-auto mb-4">{process.step}</div>
                    <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">{process.title}</h3>
                    <p className="text-gray-600 dark:text-gray-300 text-sm">{process.desc}</p>
                  </div>
                  {index < 3 && (<div className="hidden md:block absolute top-1/2 -right-3 w-6 h-1 bg-amber-400 transform -translate-y-1/2" />)}
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="py-20 px-4 md:px-10 bg-gradient-to-r from-amber-400 to-yellow-500 text-black text-center relative overflow-hidden">
          ...
          <div className="max-w-3xl mx-auto relative z-10">
            ...
            <p className="text-lg mb-8 max-w-2xl mx-auto">Let's discuss how Boostify can transform your business and help you achieve your goals. Contact us today for a personalized consultation.</p>

            <div className="flex gap-4 justify-center flex-wrap">
              <a href="/contact" className="inline-block bg-black hover:bg-gray-800 text-amber-400 font-semibold py-3 px-8 rounded-md shadow-md transition-all duration-300 hover:scale-105">Get in Touch</a>
              <a href="/" className="inline-block bg-white hover:bg-gray-100 text-black font-semibold py-3 px-8 rounded-md shadow-md transition-all duration-300 hover:scale-105">Learn More</a>
            </div>
          </div>
        </section>
      </main>
